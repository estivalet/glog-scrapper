...
current_page = 1
url = 'https://gamesdb.launchbox-app.com/platforms/games/65'
...
while current_page <= total_pages:
    ...
    for item in tree.xpath('//a[@class="list-item"]'):
        ...
        with open('c:/temp/electron/' + name[0].replace(":"," -").replace("*"," ").replace("?", " ").replace("/"," ").replace("\\","").replace("\"","'") + '.json', 'w') as outfile:
